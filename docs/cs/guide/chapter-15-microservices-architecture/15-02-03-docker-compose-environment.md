...
**이전**: [Docker 컨테이너화 전략](./15-02-01-docker-containerization.md)  
**다음**: [Kubernetes 프로덕션 배포](chapter-15-microservices-architecture/16-51-3-kubernetes-production-deployment.md)에서 본격적인 오케스트레이션을 학습합니다.
...
- [15.2.4 Docker 기초와 실무 활용](./15-02-04-docker-fundamentals.md)
- [15.2.5 로칼 개발 환경 구성](./15-02-05-local-development.md)

### 🏷️ 관련 키워드

`docker-compose`, `microservices`, `local-development`, `multi-service-orchestration`, `development-environment`
