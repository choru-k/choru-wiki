...
# 5. 메모리 매핑 성능
echo -e "\n=== 5. 메모리 매핑 성능 ==="
if [ -f "../11-06-01-disk-io-monitoring.md" ]; then
...
**이전**: [네트워크 I/O 최적화](11-04-03-network-io-optimization.md)  
**다음**: [I/O 성능 최적화 개요](11-04-01-io-optimization.md)로 돌아가서 전체 내용을 복습하세요.
...
`disk-io`, `monitoring`, `optimization`, `direct-io`, `filesystem-tuning`
