...
**이전**: [16.2A Event-Driven 아키텍처 기초](./16-02-02-event-driven-fundamentals.md)  
**다음**: [16.2C 이벤트 소싱 구현](./16-03-05-event-sourcing-implementation-advanced.md)에서 이벤트 스토어와 집합체 패턴을 학습합니다.
