...
[15.5 API Gateway 패턴](chapter-16-distributed-system-patterns/16-55-api-gateway-patterns.md)에서는 클라이언트와 마이크로서비스 사이의 모든 통신을 중재하고 최적화하는 API Gateway의 고급 패턴들을 심도 있게 다뤄보겠습니다.
...
`saga-pattern`, `distributed-transactions`, `microservices`, `orchestration`, `choreography`
