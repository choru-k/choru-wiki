...
**이전**: [단일 책임 원칙](./16-01-02-single-responsibility-principle.md)  
**다음**: [API Contract First 설계](./16-01-05-api-contract-first.md)에서 서비스 간 계약 기반 개발을 학습합니다.
...
`database-per-service`, `microservices`, `distributed-transactions`, `saga-pattern`, `event-sourcing`
