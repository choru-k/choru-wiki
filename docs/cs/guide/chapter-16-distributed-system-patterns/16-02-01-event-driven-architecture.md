...
### 1️⃣ [Event-Driven Architecture 기초](./16-02-02-event-driven-fundamentals.md)
...
### 2️⃣ [실시간 스트림 처리](./16-02-03-real-time-stream-processing.md)
...
### 3️⃣ [이벤트 소싱 구현](./16-03-05-event-sourcing-implementation-advanced.md)
...
### 4️⃣ [베스트 프랙티스와 성공 요인](./16-07-01-best-practices-success-factors.md)
...
- [CQRS와 Event Sourcing](./16-03-02-cqrs-event-sourcing.md) - 심화 아키텍처 패턴

### 후속 학습

- [Saga Pattern](./16-04-01-saga-pattern.md) - 분산 트랜잭션 관리
- [API Gateway Patterns](./16-05-04-api-gateway-patterns.md) - 마이크로서비스 통신 최적화
...
**시작**: [16.2A Event-Driven Architecture 기초](./16-02-02-event-driven-fundamentals.md)에서 실시간 추천 시스템 구축 사례를 통해 Event-Driven Architecture의 핵심 개념을 학습합니다.
