...
**이전**: [Bash 스크립트를 통한 친화도 관리](chapter-01-process-thread/07b-cpu-affinity-scripts.md)  
**다음**: [실시간 성능 시각화](chapter-01-process-thread/01-31-performance-visualization.md)에서 시각적 분석 도구를 학습합니다.
