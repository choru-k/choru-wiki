...
**이전**: [4.2b 뮤텍스 기초](chapter-01-process-thread/01-02-mutex-basics.md)  
**다음**: [4.2d 고급 락킹 기법](chapter-01-process-thread/01-20-advanced-locking.md)에서 읽기-쓰기 락과 Lock-Free 프로그래밍을 학습합니다.
...
`semaphore`, `condition_variable`, `producer_consumer`, `thread_pool`, `pthread`
