...
**이전**: [CPU 친화도 최적화 개요](chapter-01-process-thread/01-30-cpu-affinity.md)  
**다음**: [Bash 스크립트를 통한 친화도 관리](chapter-01-process-thread/07b-cpu-affinity-scripts.md)에서 실용적인 관리 도구를 학습합니다.
