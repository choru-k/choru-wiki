...
**이전**: [4.4a 시그널 기초](chapter-01-process-thread/04-04-signals-basics.md)  
**다음**: [4.4c 메시지 큐와 공유 메모리](chapter-01-process-thread/04c-message-queues-shared-memory.md)에서 고성능 IPC 메커니즘을 학습합니다.
