...
- [4.1 프로세스 기초](./01-02-01-process-creation.md) - 프로세스 개념과 메모리 구조

### 후속 학습 추천

- [4.3 스케줄링](./01-04-01-scheduling.md) - 스레드 스케줄링과 우선순위
- [4.4 Signal과 IPC](./01-03-05-signal-ipc.md) - 프로세스 간 통신
...
**다음**: [4.2a 스레드 기초와 구현](./01-01-01-thread-fundamentals.md)에서 멀티스레딩 여정을 시작하세요!
