...
1. [CPU 친화도 기초](./04-06-cpu-affinity-fundamentals.md) → 기본 개념과 C 도구 이해
2. [실시간 시각화](./04-31-performance-visualization.md) → 시각적 효과 확인
3. [Bash 스크립트](./07b-cpu-affinity-scripts.md) → 실무 적용 연습
4. 간단한 테스트 애플리케이션으로 실습

### 중급자 (심화 학습)

1. [Python 고급 관리](./04-22-python-advanced-manager.md) → 지능형 분석 도구
2. [최적화 전략](./04-32-optimization-strategies.md) → 실전 시나리오 학습
3. 실제 프로덕션 환경 적용
