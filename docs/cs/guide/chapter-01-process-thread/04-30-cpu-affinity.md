...
### 4️⃣ [실시간 성능 시각화](chapter-01-process-thread/01-31-performance-visualization.md)
...
1. [CPU 친화도 기초](chapter-01-process-thread/01-06-cpu-affinity-fundamentals.md) → 기본 개념과 C 도구 이해
