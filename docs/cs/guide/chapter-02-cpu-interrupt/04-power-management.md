...
### 1️⃣ [기본 개념과 아키텍처](chapter-02-cpu-interrupt/05-06-power-fundamentals.md)
...
### 2️⃣ [DVFS와 동적 주파수 조절](chapter-02-cpu-interrupt/04b-dvfs-frequency-scaling.md)
...
### 3️⃣ [C-State와 절전 모드](chapter-02-cpu-interrupt/04c-cstate-idle-management.md)
...
1. [기본 개념](chapter-02-cpu-interrupt/05-06-power-fundamentals.md) → 전력 관리 기초 이해
2. [C-State](chapter-02-cpu-interrupt/04c-cstate-idle-management.md) → 절전 모드 원리
3. 간단한 전력 모니터링 실습

### 중급자 (심화 학습)

1. [DVFS](chapter-02-cpu-interrupt/04b-dvfs-frequency-scaling.md) → 고급 주파수 제어
...
- [CPU 아키텍처](chapter-02-cpu-interrupt/05-01-cpu-architecture.md) - 기본 CPU 구조 이해
- [인터럽트 처리](chapter-02-cpu-interrupt/05-12-interrupt-exception.md) - 하드웨어 제어 메커니즘
...
**다음**: 먼저 [전력 관리 기본 개념](chapter-02-cpu-interrupt/05-06-power-fundamentals.md)에서 P-State와 C-State의 기초를 학습하세요.
...
- [CPU 아키텍처와 실행 모드](chapter-02-cpu-interrupt/05-01-cpu-architecture.md) - CPU 기초 구조와 Protection Ring
- [인터럽트와 예외 처리](chapter-02-cpu-interrupt/05-12-interrupt-exception.md) - 인터럽트 메커니즘
- [컨텍스트 스위칭](chapter-02-cpu-interrupt/05-16-context-switching.md) - 프로세스 전환과 CPU 상태
