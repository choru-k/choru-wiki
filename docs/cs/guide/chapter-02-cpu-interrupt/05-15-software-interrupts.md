...
**이전**: [인터럽트 컨트롤러와 최적화](chapter-02-cpu-interrupt/02-14-interrupt-controllers.md)  
**다음**: [컨텍스트 스위칭](chapter-02-cpu-interrupt/02-16-context-switching.md)에서 인터럽트에 의한 프로세스 전환을 학습합니다.
