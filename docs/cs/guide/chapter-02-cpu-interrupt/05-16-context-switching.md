...
### 1️⃣ [CPU 컨텍스트 기초](chapter-02-cpu-interrupt/02-04-context-fundamentals.md)
...
### 2️⃣ [컨텍스트 스위칭 메커니즘](chapter-02-cpu-interrupt/02-18-switching-mechanisms.md)
...
### 3️⃣ [성능 오버헤드 분석](chapter-02-cpu-interrupt/02-40-overhead-analysis.md)
...
### 4️⃣ [최적화 전략과 실전 사례](chapter-02-cpu-interrupt/02-32-optimization-strategies.md)
...
1. [CPU 컨텍스트 기초](chapter-02-cpu-interrupt/02-04-context-fundamentals.md) → 기본 개념 이해
2. [컨텍스트 스위칭 메커니즘](chapter-02-cpu-interrupt/02-18-switching-mechanisms.md) → 실제 동작 원리
3. 간단한 멀티스레드 프로그램으로 실습

### 중급자 (심화 학습)

1. [성능 오버헤드 분석](chapter-02-cpu-interrupt/02-40-overhead-analysis.md) → 성능 문제 진단
2. [최적화 전략과 실전 사례](chapter-02-cpu-interrupt/02-32-optimization-strategies.md) → 고급 최적화 기법
...
- [CPU 아키텍처와 실행 모드](chapter-02-cpu-interrupt/02-01-cpu-architecture.md) - CPU 기초 구조 이해
- [인터럽트와 예외 처리](chapter-02-cpu-interrupt/02-12-interrupt-exception.md) - 인터럽트 메커니즘
...
**다음**: 먼저 [CPU 컨텍스트 기초](chapter-02-cpu-interrupt/02-04-context-fundamentals.md)에서 컨텍스트의 구성 요소를 학습하세요.
