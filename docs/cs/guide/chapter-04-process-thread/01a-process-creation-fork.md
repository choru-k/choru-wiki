...
# Chapter 4-1A: fork() 시스템 콜과 프로세스 복제 메커니즘
...
**이전**: [Chapter 4 Process & Thread 개요](01-process-creation.md)  
**다음**: [01b-program-replacement-exec.md](01b-program-replacement-exec.md)에서 exec() 패밀리와 프로그램 교체 메커니즘을 학습합니다.
