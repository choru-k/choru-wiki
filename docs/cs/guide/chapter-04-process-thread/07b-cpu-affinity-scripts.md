...
# Chapter 4-7B: Bash 스크립트를 통한 CPU 친화도 관리
...
**이전**: [CPU 친화도 기초와 분석](07a-cpu-affinity-fundamentals.md)  
**다음**: [Python 기반 고급 관리 도구](07c-python-advanced-manager.md)에서 정교한 분석과 자동화를 학습합니다.
