...
# 4.3b CFS 구현 세부사항: Nice 값과 가중치 시스템
...
**이전**: [4.3a 스케줄링 기초와 CFS 원리](03a-scheduling-fundamentals.md)  
**다음**: [4.3c 실시간 스케줄링](03c-realtime-scheduling.md)에서 FIFO, RR, DEADLINE 스케줄링을 학습합니다.
