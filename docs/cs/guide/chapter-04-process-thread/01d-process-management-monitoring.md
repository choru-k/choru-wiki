...
**이전**: [01c-process-termination-zombies.md](01c-process-termination-zombies.md)  
**다음**: [02-thread-sync.md](02-thread-sync.md)에서 스레드와 동기화 기법을 학습합니다.
