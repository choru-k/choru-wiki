...
**이전**: [Python GC 기본 구조](./08-03-03-python-gc-fundamentals.md)  
**다음**: [실제 서비스 GC 최적화 사례](./08-04-02-python-gc-production.md)에서 Instagram, Dropbox 등의 실제 프로덕션 최적화 경험을 학습합니다.
