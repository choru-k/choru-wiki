...
**이전**: [10.6.1 이벤트 소싱과 CQRS](./10-06-01-event-sourcing-cqrs.md)
**다음**: [10.6.3 복원력 패턴](./10-06-03-resilience-patterns.md)에서 Circuit Breaker와 복원력 패턴을 학습합니다.
...
`kafka`, `back-pressure`, `exactly-once`, `reactive-streams`, `flow-control`
