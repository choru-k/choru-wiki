...
**이전**: [기초 개념과 패러다임](14-04-02-event-driven-fundamentals.md)  
**다음**: [Event Streaming과 Event Sourcing](14-04-05-event-streaming-sourcing.md)에서 Kafka와 Event Sourcing 패턴을 학습합니다.
