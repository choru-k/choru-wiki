...
**이전**: [Event Streaming과 Event Sourcing](14-04-05-event-streaming-sourcing.md)  
...
`event-driven-architecture`, `event-sourcing`, `microservices`, `distributed-systems`, `saga-pattern`
