...
**이전**: [Saga Pattern](14-03-03-saga-pattern.md)  
**다음**: [분산 패턴 개요](14-05-03-distributed-patterns.md)로 돌아가서 다른 패턴들과의 연결점을 확인하세요.
...
`cqrs`, `command-query-separation`, `event-sourcing`, `domain-events`, `read-model`
