...
합의 알고리즘을 마스터했으니, [14.3 분산 데이터 관리](14-02-02-distributed-data.md)에서는 실제로 데이터를 어떻게 분산 저장하고 관리하는지, 샤딩과 복제 전략을 배워보겠습니다.
...
`consensus`, `raft`, `pbft`, `leader-election`, `log-replication`
