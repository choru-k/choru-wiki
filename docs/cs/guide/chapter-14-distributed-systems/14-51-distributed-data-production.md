...
분산 데이터 관리의 기반을 다졌으니, [14.4 분산 시스템 패턴](14-52-distributed-patterns.md)에서는 Circuit Breaker, Saga, CQRS 같은 실전 패턴들을 배워보겠습니다.
...
**이전**: [Vector Clock과 충돌 해결](14-13-vector-clocks.md)  
**다음**: [분산 시스템 패턴](14-52-distributed-patterns.md)에서 고급 분산 시스템 패턴들을 학습합니다.
