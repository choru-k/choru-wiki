...
**이전**: [분산 패턴 개요](14-05-03-distributed-patterns.md)  
**다음**: [Bulkhead Pattern](14-03-02-bulkhead-pattern.md)에서 리소스 격리를 통한 장애 전파 차단을 학습합니다.
...
`circuit-breaker`, `fault-tolerance`, `resilience-patterns`, `distributed-systems`, `cascade-failure-prevention`
