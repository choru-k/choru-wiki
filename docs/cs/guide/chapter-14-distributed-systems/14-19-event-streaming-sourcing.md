...
# 14.5C Event Streaming과 Event Sourcing - 이벤트를 진실의 원천으로
...
**이전**: [Message Queue 구현](14-18-message-queue-implementation.md)  
**다음**: [실무 적용과 성숙도 모델](14-04-practical-implementation-guide.md)에서 실전 도입 전략을 학습합니다.
