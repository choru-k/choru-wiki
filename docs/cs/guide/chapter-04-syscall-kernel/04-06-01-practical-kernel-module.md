...
**이전**: [04-05-01-sync-memory-debug.md](04-05-01-sync-memory-debug.md)  
**다음 단계**: 전체 커널 아키텍처 이해를 바탕으로 [04-01-07-system-call-implementation.md](04-01-07-system-call-implementation.md)에서 시스템 호출 내부 구현을 학습합니다.
