...
**이전**: [04-40-sync-memory-debug.md](04-40-sync-memory-debug.md)  
**다음 단계**: 전체 커널 아키텍처 이해를 바탕으로 [04-14-system-call-implementation.md](04-14-system-call-implementation.md)에서 시스템 호출 내부 구현을 학습합니다.
