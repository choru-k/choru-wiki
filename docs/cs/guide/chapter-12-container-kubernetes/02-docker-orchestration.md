...
- [12.1 Container 핵심 기술](01-container-internals.md) - 컨테이너의 기본 원리와 격리 메커니즘
- [12.3 Kubernetes 기본 원리](03-kubernetes-fundamentals.md) - Docker 다음 단계인 Kubernetes 기초
- [Chapter 6: File I/O](../chapter-06-file-io/index.md) - 컨테이너 볼륨과 스토리지 최적화
- [Chapter 11: Performance Optimization](../chapter-11-performance-optimization/index.md) - 컨테이너 성능 튜닝
