...
**이전**: [Chapter 7-2A: 네트워크 스택 아키텍처](02a-network-stack-architecture.md)  
**다음**: [Chapter 7-2C: TCP 혼잡 제어](02c-tcp-congestion-control.md)에서 네트워크 성능 최적화를 위한 혼잡 제어 알고리즘을 학습합니다.
