...
**이전**: [13.1A 관찰 가능성 기초](12-01-01-observability-foundations.md)  
**다음**: [13.1C 메트릭 수집](12-03-05-advanced-metrics-collection.md)에서 시스템 상태를 수치로 측정하는 메트릭 시스템을 학습합니다.
...
`structured_logging`, `json_logging`, `observability`, `monitoring`, `elasticsearch`
