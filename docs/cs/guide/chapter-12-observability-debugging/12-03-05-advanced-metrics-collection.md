...
**이전**: [13.1B 구조화된 로깅](12-03-04-advanced-structured-logging.md)  
**다음**: [13.1D 알림 관리](12-03-06-advanced-alert-management.md)에서 지능적인 알림 시스템으로 문제를 사전에 감지하는 방법을 학습합니다.
...
`prometheus`, `grafana`, `metrics`, `monitoring`, `instrumentation`
