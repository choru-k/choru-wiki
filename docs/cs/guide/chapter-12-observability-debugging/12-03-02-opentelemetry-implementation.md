...
**이전**: [12.1.2 분산 추적 기초](./12-01-02-tracing-fundamentals.md)  
**다음**: [12-04-01-sampling-optimization.md](12-04-01-sampling-optimization.md)에서 성능 최적화된 샘플링 전략을 학습합니다.
...
`opentelemetry`, `distributed-tracing`, `microservices`, `observability`, `jaeger`
