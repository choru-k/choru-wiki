...
**이전**: [12.2.3 로깅 및 모니터링 개요](./12-02-03-logging-monitoring.md)  
**다음**: [12.2.2 메트릭 수집](./12-02-02-metrics-collection.md)에서 Prometheus와 Grafana를 활용한 시스템 메트릭 수집을 학습합니다.
...
`structured_logging`, `json_logging`, `contextvar`, `observability`, `monitoring`
