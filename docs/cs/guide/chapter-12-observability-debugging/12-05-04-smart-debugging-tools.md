...
**이전**: [13.5b 분산 시스템 디버깅](12-05-03-distributed-debugging.md)  
**다음**: [13.5d 로그 분석과 자동 디버깅](12-05-05-log-analysis-debugging.md)에서 로그 기반 디버깅 기법을 학습합니다.
...
`debugging`, `conditional-breakpoints`, `auto-debugging`, `memory-profiling`, `performance-monitoring`
