...
분산 추적으로 마이크로서비스의 요청 흐름을 파악했으니, [13.3 메트릭 수집 및 알림 시스템](12-03-03-metrics-alerts.md)에서는 시스템 건강도를 측정하고 문제를 미리 감지하는 방법을 배워보겠습니다.
...
`distributed-tracing`, `opentelemetry`, `jaeger`, `microservices`, `observability`
