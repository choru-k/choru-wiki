...
**이전**: [13.1C 메트릭 수집](12-15-metrics-collection.md)  
**다음**: [13.1E 관찰 가능성 베스트 프랙티스](01e-observability-best-practices.md)에서 로깅, 메트릭, 알림을 통합한 베스트 프랙티스를 학습합니다.
