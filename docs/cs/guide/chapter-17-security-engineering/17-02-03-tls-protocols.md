...
**이전**: [네트워크 보안 기초와 위협 환경](./17-01-01-network-fundamentals.md)  
**다음**: [DDoS 공격 탐지와 방어 시스템](./17-02-04-ddos-defense.md)에서 대규모 분산 공격에 대한 탐지와 방어 메커니즘을 학습합니다.
