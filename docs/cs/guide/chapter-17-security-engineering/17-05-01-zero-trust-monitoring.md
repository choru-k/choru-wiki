...
**이전**: [DDoS 공격 탐지와 방어 시스템](./17-02-04-ddos-defense.md)  
**다음**: [인증과 인가](./17-03-01-authentication-authorization.md)에서 애플리케이션 레벨 보안과 현대적인 인증 시스템을 학습합니다.
