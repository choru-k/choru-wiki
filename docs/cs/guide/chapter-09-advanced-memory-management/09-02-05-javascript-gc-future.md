...
**이전**: [9.3d3 대규모 SPA 메모리 관리](./09-02-03-spa-memory-management.md)  
**메인**: [9.3d JavaScript GC 개요](./09-02-01-javascript-gc.md)에서 전체 로드맵을 확인하세요.
...
`V8 엔진`, `가비지 컬렉션`, `메모리 최적화`, `성능 튜닝`, `JavaScript 고급`
