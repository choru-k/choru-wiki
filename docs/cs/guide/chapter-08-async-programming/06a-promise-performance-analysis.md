...
**이전**: [Promise 성능 최적화 개요](06-promise-performance-optimization.md)  
**다음**: [JavaScript Promise 최적화 라이브러리](06b-promise-optimization-library.md)에서 실용적인 JavaScript 최적화 도구를 학습합니다.
