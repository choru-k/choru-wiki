...
**이전**: [동기식 통신 - REST API와 Circuit Breaker](01c1-synchronous-communication.md)  
**다음**: [통신 패턴 선택과 실전 최적화](01c3-communication-patterns-best-practices.md)에서 전체 통신 전략을 학습합니다.
