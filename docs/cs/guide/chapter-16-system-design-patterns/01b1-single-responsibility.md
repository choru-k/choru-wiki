...
# 16.1B1 단일 책임 원칙 (Single Responsibility Principle)
...
**이전**: [마이크로서비스 설계 원칙 개요](01b-design-principles.md)  
**다음**: [Database per Service 패턴](01b2-database-per-service.md)에서 서비스별 데이터베이스 분리 전략을 학습합니다.
