...
- **[16.5A API Gateway 기초](05a-api-gateway-fundamentals.md)** - API Gateway 패턴의 기본 개념
...
- **[16.5E 성공 요인](05e-success-factors-best-practices.md)** - 실무 적용 가이드와 베스트 프랙티스
- **[16.5 API Gateway 패턴 종합](05-api-gateway-patterns.md)** - 전체 개요와 학습 로드맵

---

**다음**: [성공 요인과 실무 가이드](05e-success-factors-best-practices.md)에서 API Gateway 도입 전략을 완성해보세요! 🏆
