...
# Chapter 5-3B: 컨텍스트 스위칭 구현 - 0.001초의 예술
...
**이전**: [컨텍스트 스위칭 기초](03a-context-switching-fundamentals.md)에서 컨텍스트 스위칭의 기본 개념을 학습했습니다.
**다음**: [컨텍스트 스위칭 오버헤드 분석](03c-context-switching-overhead.md)에서 성능 비용과 최적화 방법을 학습합니다.
