...
# Chapter 5-3C: 컨텍스트 스위칭 오버헤드 - 보이지 않는 비용
...
**이전**: [컨텍스트 스위칭 구현](03b-context-switching-implementation.md)에서 상세한 구현 과정을 학습했습니다.
**다음**: [실전 최적화 사례](03d-context-switching-optimization.md)에서 실제 프로덕션 환경의 최적화 사례들을 학습합니다.
