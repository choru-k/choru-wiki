...
**이전**: [파일시스템별 구현](chapter-06-file-io/06-17-filesystem-impl.md)  
**다음**: [Chapter 6-3: 블록 I/O와 디스크 스케줄링](chapter-06-file-io/06-18-block-io.md)에서 하위 계층의 블록 디바이스 추상화를 학습합니다.
