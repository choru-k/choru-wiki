...
**이전**: [io_uring: 차세대 비동기 I/O](./06-03-03-io-uring-implementation.md)  
**다음**: [프로액터 패턴과 Windows IOCP](./06-03-05-proactor-iocp.md)에서 완료 기반 I/O 모델을 학습합니다.
