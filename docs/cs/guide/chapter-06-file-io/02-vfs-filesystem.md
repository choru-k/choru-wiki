...
### 1️⃣ [VFS 기본 개념과 아키텍처](02a-vfs-fundamentals.md)
...
### 2️⃣ [경로명 조회와 덴트리 캐시](02b-path-lookup.md)
...
### 3️⃣ [마운트 시스템과 네임스페이스](02c-mount-system.md)
...
### 4️⃣ [VFS 캐시 시스템](02d-vfs-cache.md)
...
### 5️⃣ [파일시스템별 구현](02e-filesystem-impl.md)
...
### 6️⃣ [성능 최적화와 튜닝](02f-performance-tuning.md)
...
1. [VFS 기본 개념](02a-vfs-fundamentals.md) → 전체 구조 이해
2. [캐시 시스템](02d-vfs-cache.md) → 성능의 핵심 파악
3. 간단한 파일시스템 마운트 실습

### 중급자 (심화 학습)

1. [경로명 조회](02b-path-lookup.md) → 내부 메커니즘 이해
2. [마운트 시스템](02c-mount-system.md) → 고급 설정 활용
3. 실제 서버 환경 최적화 적용

### 고급자 (전문가 과정)

1. [파일시스템 구현](02e-filesystem-impl.md) → 각 FS별 특성
2. [성능 튜닝](02f-performance-tuning.md) → 프로덕션 최적화
3. 커스텀 파일시스템 개발 도전
...
- [Chapter 6-1: 파일 디스크립터와 시스템 콜](01-file-descriptor.md) - 기초 파일 I/O

### 후속 학습

- [Chapter 6-3: 블록 I/O와 디스크 스케줄링](03-block-io.md) - 하위 계층 이해
...
**다음**: [VFS 기본 개념과 아키텍처](02a-vfs-fundamentals.md)에서 VFS의 핵심 구조와 동작 원리를 학습합니다.
