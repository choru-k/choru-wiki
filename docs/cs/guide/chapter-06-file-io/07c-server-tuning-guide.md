...
**이전**: [자동 최적화 스크립트](07b-auto-optimization-scripts.md)  
**다음**: [모니터링 및 트러블슈팅](07d-monitoring-troubleshooting.md)에서 운영 환경에서의 실시간 관리 방법을 학습합니다.
