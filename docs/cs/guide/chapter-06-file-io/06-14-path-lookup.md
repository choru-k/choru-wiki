...
**이전**: [VFS 기본 개념과 아키텍처](chapter-06-file-io/06-02-vfs-fundamentals.md)  
**다음**: [마운트 시스템과 네임스페이스](chapter-06-file-io/06-15-mount-system.md)에서 파일시스템 통합 메커니즘을 학습합니다.
