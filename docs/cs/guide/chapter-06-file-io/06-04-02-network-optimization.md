...
**이전**: [프로액터 패턴과 Windows IOCP](./06-03-05-proactor-iocp.md)  
**다음**: [Chapter 7: 네트워크 프로그래밍](../chapter-07-network-programming/07-01-01-socket-basics.md)에서 소켓 프로그래밍의 기초를 학습합니다.
