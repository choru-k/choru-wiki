...
### 1️⃣ [VFS 기본 개념과 아키텍처](./06-01-02-vfs-fundamentals.md)
...
### 2️⃣ [경로명 조회와 덴트리 캐시](./06-02-05-path-lookup.md)
...
### 3️⃣ [마운트 시스템과 네임스페이스](./06-02-06-mount-system.md)
...
### 4️⃣ [VFS 캐시 시스템](./06-02-07-vfs-cache.md)
...
### 5️⃣ [파일시스템별 구현](./06-02-08-filesystem-impl.md)
...
### 6️⃣ [성능 최적화와 튜닝](./06-04-01-performance-tuning.md)
...
- [6.2.1: 파일 디스크립터와 시스템 콜](./06-02-01-file-descriptor.md) - 기초 파일 I/O

### 후속 학습

- [Chapter 6-3: 블록 I/O와 디스크 스케줄링](./06-02-09-block-io.md) - 하위 계층 이해
...
**다음**: [VFS 기본 개념과 아키텍처](./06-01-02-vfs-fundamentals.md)에서 VFS의 핵심 구조와 동작 원리를 학습합니다.
