...
**이전**: [경로명 조회와 덴트리 캐시](chapter-06-file-io/06-14-path-lookup.md)  
**다음**: [VFS 캐시 시스템](chapter-06-file-io/06-16-vfs-cache.md)에서 3단계 캐시 메커니즘의 성능 비밀을 학습합니다.
