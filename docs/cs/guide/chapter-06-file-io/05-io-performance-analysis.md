...
void calculate_io_metrics(diskstats_t* prev, diskstats_t* curr, double interval, io_metrics_t* metrics) {
    ...
    unsigned long long read_time = curr->time_reading - prev->time_reading;
    unsigned long long write_time = curr->time_writing - prev->time_writing;
    ...
    metrics->utilization = (double)io_time / (interval * 1000) * 100;
