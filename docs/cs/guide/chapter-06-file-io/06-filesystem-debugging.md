...
### 1️⃣ [진단 방법론과 흐름도](06a-filesystem-diagnostic-flow.md)
...
### 2️⃣ [종합 진단 도구 구현](06b-filesystem-diagnostic-tools.md)
...
1. [진단 방법론](06a-filesystem-diagnostic-flow.md) → 전체적인 접근 방법 이해
2. [진단 도구](06b-filesystem-diagnostic-tools.md) → 실제 도구 사용법 학습
3. 간단한 파일시스템 검사 실습

### 중급자 (실무 적용)

1. [종합 진단 도구](06b-filesystem-diagnostic-tools.md) → C 구현체 분석
...
- [파일 디스크립터와 VFS](01-file-descriptor.md) - 파일시스템 기초 이해
- [블록 I/O 시스템](03-block-io.md) - 저수준 I/O 메커니즘

### 후속 학습

- [네트워크 파일시스템 최적화](07-network-filesystem-optimization.md) - 분산 환경에서의 파일시스템
- [I/O 성능 분석](05-io-performance-analysis.md) - 성능 튜닝
...
**다음**: [파일시스템 진단 방법론](06a-filesystem-diagnostic-flow.md)에서 체계적인 문제 해결 접근법을 학습합니다.
