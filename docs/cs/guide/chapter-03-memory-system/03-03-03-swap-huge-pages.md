...
**이전**: [페이지 폴트와 TLB](./03-02-02-tlb-caching.md)  
**다음**: [가상 메모리 개요](./03-01-03-virtual-memory-basics.md)로 돌아가서 전체 내용을 정리하거나, [메모리 매핑과 공유 메모리](./03-03-04-memory-mapping.md)에서 고급 메모리 기법을 학습합니다.
