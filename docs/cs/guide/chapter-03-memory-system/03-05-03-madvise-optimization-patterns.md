...
**이전**: [mmap vs read/write 성능 비교](./03-05-02-mmap-performance-comparison.md)  
**다음**: [Huge Pages 최적화](./03-05-04-huge-pages-optimization.md)에서 TLB 효율성 극대화 방법을 학습합니다.
