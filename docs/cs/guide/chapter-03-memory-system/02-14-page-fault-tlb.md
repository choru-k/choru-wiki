...
**이전**: [페이징 시스템](chapter-03-memory-system/03-13-paging-system.md)  
**다음**: [스왑과 대용량 페이지 활용](chapter-03-memory-system/03-15-swap-huge-pages.md)에서 스왑 메커니즘과 Huge Pages의 성능 최적화를 학습합니다.
...
`page-fault`, `tlb`, `copy-on-write`, `demand-paging`, `memory-optimization`
