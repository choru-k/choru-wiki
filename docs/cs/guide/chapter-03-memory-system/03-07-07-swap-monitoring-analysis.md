...
**이전**: [압축 스왑 기술](./03-04-03-compressed-swap-technologies.md)  
**다음**: [컨테이너 스왑 관리 실무](./03-06-06-container-swap-management.md)에서 Docker와 Kubernetes 환경에서의 스왑 관리 전략을 학습합니다.
...
`swap`, `monitoring`, `performance_analysis`, `system_administration`, `real_time_tracking`
