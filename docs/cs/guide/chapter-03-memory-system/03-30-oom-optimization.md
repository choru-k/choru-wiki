...
**이전**: [스왑과 메모리 압박](./03-16-swap-memory-pressure.md)에서 시스템이 느려지는 이유를 학습했습니다.
**다음**: [메모리 압축과 중복 제거](./03-17-compression-deduplication.md)에서 8GB RAM으로 16GB처럼 쓰는 방법을 학습합니다.
