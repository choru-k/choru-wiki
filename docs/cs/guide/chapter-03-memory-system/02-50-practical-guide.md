...
**이전**: [고급 메모리 관리 기법](chapter-03-memory-system/03-20-advanced-techniques.md)  
**메인**: [스택과 힙 개요](chapter-03-memory-system/03-11-stack-heap.md)로 돌아가기  
**다음**: [Chapter 2-3: 가상 메모리와 페이징](chapter-03-memory-system/03-12-virtual-memory.md)에서 프로세스가 보는 환상의 메모리 세계를 탐구합니다.
