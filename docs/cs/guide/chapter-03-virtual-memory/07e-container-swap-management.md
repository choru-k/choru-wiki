...
**이전**: [스왑 모니터링과 패턴 분석](07d-swap-monitoring-analysis.md)  
**다음**: [스왑 관리와 최적화 개요](07-swap-management.md)로 돌아가서 전체 학습 로드맵을 확인하거나, [OOM 디버깅](08-oom-debugging.md)에서 메모리 부족 상황 대응을 학습합니다.
