...
# Chapter 3-3B: Copy-on-Write (CoW) - fork()가 빠른 이유
...
**이전**: [페이지 폴트 종류와 처리](03a-page-fault-types-handling.md)에서 기본 폴트 메커니즘을 학습했습니다.
**다음**: [Demand Paging 메커니즘](03c-demand-paging.md)에서 게으른 메모리 할당의 비밀을 학습합니다.
