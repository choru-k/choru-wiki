...
# Chapter 3-3D: 스왑과 메모리 압박 - 컴퓨터의 숨막히는 순간
...
**이전**: [Demand Paging 메커니즘](03c-demand-paging.md)에서 게으른 메모리 할당을 학습했습니다.
**다음**: [OOM Killer와 최적화](03e-oom-optimization.md)에서 메모리 부족 시 시스템의 극단적 선택을 학습합니다.
